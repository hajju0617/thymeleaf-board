...
public class GlobalConst {
    ...
    public static final String ERROR_QUERY_STRING_MISMATCH = "정상적인 요청이 아니예요. 다시 시도해 주세요.";
    ...
    public static final String ERROR_AUTHOR_MISMATCH = "본인이 작성한 글/댓글만 수정하거나 삭제할 수 있어요";
